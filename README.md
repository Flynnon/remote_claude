...
- [docs/configuration.md](./docs/configuration.md) — 配置说明与环境变量入口
- [docs/feishu-setup.md](./docs/feishu-setup.md) — 飞书应用与机器人配置入口
...
- [docker/README.md](./docker/README.md) — Docker 测试与镜像验证入口
- [tests/README.md](./tests/README.md) — 测试入口、回归入口与测试说明
- [docs/developer.md](./docs/developer.md) — 开发者总览与研发入口
